...
const renderTeacherCard = () => {
  ...
  <div class="card d-flex justify-content-center" style="width: 18rem;">
      ...
      <div class="card-body">
          <h5 class="card-title">${teacher.textNameAndSurname}</h5>
          <p>${teacher.textSpeciality}</p>
          <p class="card-text">${teacher.textDescription}</p>
        ...
        <div class="text-center" id="plus-image">
            <img src="./images/plus.png" class="rounded" alt="Bootstrap" width="50" height="50">
          </div>`
        };
